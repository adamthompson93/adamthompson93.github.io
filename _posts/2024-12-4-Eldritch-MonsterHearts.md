...
```
When you take the time to process what has shocked you, once per session you may heal 1 Shock. If someone else is there with you, and they have a String on you,
```
